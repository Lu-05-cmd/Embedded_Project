 ...
 * @file    : gpio.h
 * @brief   : 
 *              - Generic GPIO driver interface for STM32F10x devices.
 *              - This file provides register definitions, base addresses.
 *              - Configuration enums, add public APIs intended to be reused across multiple STM32F10x series.
 * @author  : lu-05-cmd
 * @date    : January, 30 2026.
 * 
 * @note : 
 *          - This is file designed based on STM32F10x reference manual (RM0008).
 *          - GPIO register layout follows the STM32F10x memory map and register description.
 *          - Implementation details may vary depending on the specific STM32F10x devices.
 **********************************************************************************************************************************************************************/
...
void GPIO_WritePin(GPIO_TypeDef *GPIO, uint16_t pin, GPIO_PinState state);
